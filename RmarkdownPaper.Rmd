...
![](Severity_Analysis/plots/exploratory/density.png "Density of claim amounts"){width=40%}
...
following the paper of `@chavent2011clustofvar` results in @chavent2011clustofvar
